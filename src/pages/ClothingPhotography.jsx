        ...
        return (
            <div>
                ...
                <div className="image-display">
                    ...
                    <img src={pic14} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:13 })} />
                    <img src={pic15} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:14 })} />
                    <img src={pic16} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:15 })} />
                    <img src={pic17} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:16 })} />
                    <img src={pic18} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:17 })} />
                    <img src={pic19} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:18 })} />
                    <img src={pic20} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:19 })} />
                    <img src={pic21} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:20 })} />
                    <img src={pic22} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:21 })} />
                    <img src={pic23} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:22 })} />
                    <img src={pic24} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:23 })} />
                    <img src={pic25} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:24 })} />
                    <img src={pic26} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:25 })} />
                    <img src={pic27} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:26 })} />
                    <img src={pic28} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:27 })} />
                    <img src={pic29} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:28 })} />
                    <img src={pic30} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:29 })} />
                    <img src={pic31} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:30 })} />
                    <img src={pic32} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:31 })} />
                    <img src={pic33} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:32 })} />
                    <img src={pic34} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:33 })} />
                    <img src={pic35} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:34 })} />
                    <img src={pic36} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:35 })} />
                    <img src={pic37} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:36 })} />
                    <img src={pic38} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:37 })} />
                    <img src={pic39} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:38 })} />
                    <img src={pic40} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:39 })} />
                    <img src={pic41} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:40 })} />
                    <img src={pic42} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:41 })} />
                    <img src={pic43} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:42 })} />
                    <img src={pic44} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:43 })} />
                    <img src={pic45} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:44 })} />
                    <img src={pic46} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:45 })} />
                    <img src={pic47} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:46 })} />
                    <img src={pic48} className="thumbnail"  onClick={() => this.setState({ isOpen: true, photoIndex:47 })} />
